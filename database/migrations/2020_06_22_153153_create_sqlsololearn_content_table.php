...
class CreateSqlsololearnContentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sqlsololearn_content', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('sqlsololearn_content');
    }
}

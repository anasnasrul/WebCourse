...
class CreateJquerysololearnContentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jquerysololearn_content', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('jquerysololearn_content');
    }
}

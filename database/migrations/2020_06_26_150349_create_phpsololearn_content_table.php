...
class CreatePhpsololearnContentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('phpsololearn_content', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('phpsololearn_content');
    }
}

...
class CreateHtmlsololearnContentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('htmlsololearn_content', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('htmlsololearn_content');
    }
}

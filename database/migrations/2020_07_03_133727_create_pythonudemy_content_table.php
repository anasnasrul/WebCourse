...
class CreatePythonudemyContentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pythonudemy_content', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::dropIfExists('pythonudemy_content');
    }
}

	<div class="sidebar" data-background-color="black" data-active-color="danger">
		...
		<div class="sidebar-wrapper">
			...
			<div id="list-example" class="list-group">
					@foreach ($jqueryyoutube1 as $jqueryyoutube1s)
				  	<a class="list-group-item list-group-item-action" href="/course/youtube/jquery"><img src="/assets/img/iconjquery.jpg" class="rounded-circle" height="16px">&nbsp {{ $jqueryyoutube1s->title }}</a>
				  	@endforeach				  
			</div>
		</div>
	</div>

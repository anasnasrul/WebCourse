...
<body>
@include('home.course.sololearn.javascript.sidebar4')
<div class="wrapper">
    <div class="main-panel">
                ...
                <div class="col-md-12"> 
                    <div class="card">
                        <div class="header" align="center">
                            <img src="/assets/img/bannersololearn.jpg" widht="80px" height="50px">                    
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                @include('home.course.sololearn.javascript.details4')
